    ...
    email: {
        ...
        validate: {
            ...
            message: function (props) {
                return "".concat(props.value, " is not valid email!");
            },
        },
    },
    name: {
...
AgentSchema.methods.comparePassword = function (canditatePassword) {
    return __awaiter(this, void 0, void 0, function () {
        var isMatch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1.default.compare(canditatePassword, this.password)];
                case 1:
                    isMatch = _a.sent();
